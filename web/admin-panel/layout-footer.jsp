...
<script src="${pageContext.request.contextPath}/admin-util/vendor/chart.js/Chart.min.js"></script>
...
<script src="${pageContext.request.contextPath}/admin-util/js/sb-admin.min.js"></script>
